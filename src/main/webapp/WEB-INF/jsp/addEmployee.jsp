...
<div class="panel panel-primary" id="panel1">
    <div class="panel-heading" style="height: 75px">
        <h1 class="panel-title" style="color: white"><b>添加员工</b></h1>
    </div>
        ...
        <div>
            <div style="margin-top: 50px">
                ...
                <div style="width: 55%;float: left;text-align: left;">
                    <input type="text" id="name" placeholder="请输入员工姓名" style="height:39px;font-size: 18px;" size="20"/>
            ...
            <div style="margin-top: 50px">
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="idCardNumber" placeholder="请输入员工身份证号" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="phone" placeholder="请输入员工联系电话" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="address" placeholder="请输入员工联系地址" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="linkedName" placeholder="请输入员工紧急联系人" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="linkedPhone" placeholder="请输入紧急联系人电话" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="linkedAddress" placeholder="请输入紧急联系人地址" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="deptName" placeholder="请输入员工所属部门" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="role" placeholder="请输入员工职位" style="height:39px;font-size: 18px;"size="20"/>
                ...
                <div style="width: 55%;float: left;text-align: left;margin-top: 40px">
                    <input type="text" id="wages" placeholder="请输入员工工资" style="height:39px;font-size: 18px;"size="20"/>
...
<script type="text/javascript">
    function add(){
        ...
        $.ajax({
            url:"employee/add",
            data:{"name":name,"idCardNumber":idCardNumber,"phone":phone,"address":address,
            ...
            success:function(data){
                if(data.result){
                    alert("添加员工成功，员工工号为："+data.jobNumber+",初始密码为123456");
                    //self.location.href = "/bysj/employeeList";
    ...
    function notDo(){
        ...
        var role = $('#role').val("");
        var wages = $('#wages').val("");
        var qualification = $('#qualification').val(0);
    }
</script>
</html>
