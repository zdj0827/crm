...
<div id="toolbar" class="btn-group">
    ...
    <form  id="search_cus">
        <div class="panel-body search_box" >
            客户名<input type="text" id="customerName" name="customerName" >
...
<script>
        ...
        if(confirm(msg)==true){
            ...
            $.ajax({
                ...
                success: function (data) {
                    if(data.result){
                        alert("删除成功！");
                        $("#customerListDg").bootstrapTable('refresh', {url: 'order/allOrders'});
                    }else {
                        alert("删除失败！");
                        return;
                    }
    ...
    $(function () {
        $('#customerListDg').bootstrapTable({
            ...
            url: "order/allOrders",//这个接口需要处理bootstrap table传递的固定参数--%>
